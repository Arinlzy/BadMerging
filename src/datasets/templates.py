...
fashion_mnist_template = [
    lambda c: f'a photo of a {c}.',
    lambda c: f'a blurry photo of a {c}.',
    lambda c: f'a black and white photo of a {c}.',
    lambda c: f'a thumbnail of a {c}.',
    lambda c: f'a photo of the {c}.',
    lambda c: f'a blurry photo of the {c}.',
    lambda c: f'a black and white photo of the {c}.',
    lambda c: f'a thumbnail of the {c}.',
]
...
dataset_to_template = {
    ...
    'Flowers': flower_templates,
    'TIN': imagenet_template,
    'ImageNet100': imagenet_template,
    'CUB200': cub_templates,
    'FashionMNIST': fashion_mnist_template
}
