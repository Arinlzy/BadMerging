...
for epoch in tqdm.tqdm(range(epochs)):
    ...
    if save_flag and ep==epochs:
        ...
        if attack_type=='Clean':
            ...
            torch.save(adamerging_mtl_model.lambdas_raw, os.path.join(adamerging_dir, f"Off_{target_task}_Tgt_{target_cls}_SD_{num_shadow_data}_SC_{num_shadow_classes}_L_{patch_size}_Epoch_{ep}.pt"))